...
This structure will expand as preview deployment, Playwright E2E testing, production deployment, and preview cleanup are implemented.
...
**GitHub build metadata → PR preview deployments → Playwright E2E → production deployment → preview cleanup → CI optimization**
